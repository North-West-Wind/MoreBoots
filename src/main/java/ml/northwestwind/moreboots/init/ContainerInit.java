...
public class ContainerInit {
    public static final MenuType<StorageBootsContainer> STORAGE_BOOTS = IForgeContainerType.create((windowId, inv, data) -> new StorageBootsContainer(windowId, inv, data.readVarInt()));
