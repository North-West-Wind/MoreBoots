...
public class VanishingPressurePlateBlock extends PressurePlateBlock {
    public VanishingPressurePlateBlock(Sensitivity sensitivity, Block block) {
        super(sensitivity, Properties.from(block));
    }
