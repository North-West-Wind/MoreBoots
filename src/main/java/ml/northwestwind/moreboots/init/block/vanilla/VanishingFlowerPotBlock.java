...
public class VanishingFlowerPotBlock extends FlowerPotBlock {
    public VanishingFlowerPotBlock(FlowerPotBlock block) {
        super(block::getEmptyPot, block::func_220276_d, Properties.from(block));
    }
