...
import ml.northwestwind.moreboots.init.item.GlowstoneDustItemBase;
import ml.northwestwind.moreboots.init.block.vanilla.*;
...
public class BlockInit {
    ...
    public static final RedstoneDustBlock REDSTONE_DUST = (RedstoneDustBlock) new RedstoneDustBlock(Block.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance()).setRegistryName("redstone_dust");
