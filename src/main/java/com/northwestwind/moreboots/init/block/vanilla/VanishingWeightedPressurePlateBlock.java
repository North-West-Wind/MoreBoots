...
public class VanishingWeightedPressurePlateBlock extends WeightedPressurePlateBlock {
    public VanishingWeightedPressurePlateBlock(int p_i48295_1_, Block block) {
        super(p_i48295_1_, Properties.from(block));
    }
