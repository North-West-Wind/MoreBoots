...
public class UnbreakableArmorItem extends Item {
    ...
    public UnbreakableArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Item.Properties p_i48534_3_) {
